<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <div class="app-content content ">
        ...
        <div class="row pl-1 pr-1 p-b-5">
            ...
            <div class="col-xl-6 col-lg-6 col-sm-6 colmspadding padding0 width50 text-right">
                <a onclick="Ex()" class="btn  btn-success m-r-5">
                ...
                <a id="1" onclick="a()" class="btn btn-primary" data-toggle="modal" data-target=".addmodal">
    ...
    <!--                    <a  onclick="updateAndHideRow(rowId)" class=" delete_alert " data-toggle="tooltip" data-placement="bottom" data-original-title="Delete"-->
    <!--                       href="javascript:void(0);">-->
        ...
        <div class="modal-dialog modal-md modal-dialog-centered  modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title " id="2">Add/Edit Category Master</label>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-sm-12 mb-2">
                                    ...
                                    <input  onkeyup="this.value = this.value.replace(/[^a-zA-Z_\s-]/g, '');" maxlength=15 id="categoryname" type="text" class="form-control fieldmandatory" placeholder="Enter Category Name">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-sm-12 mb-1">
                                    <label class="lable-align">Description</label>
                                    <textarea  maxlength=100 id="description" class="form-control fieldmandatory textareasize" placeholder="Enter Description"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="row">
                        ...
                        <div  class="col-xl-6 col-lg-6 col-sm-6 text-right colmspadding">
                                <a onclick="xyz()" href="javascript:void(0)" class="btn btn-success  m-r-5"   >
    ...
    <script src="/product_master.js/CategoryMaster.js"></script>
