                ...
                <div class="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="password" id="passwo" class="form-control" placeholder="Enter Password">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="d-flex justify-content-between">
                    ...
                    <div class="input-group ">
                      ...
                      <input type="password" id="passwo1" class="form-control" placeholder="Enter Confirm Password">
                    </div>
                  </div>
                  <a  onclick="validateForm()"   class="btn btn-primary btn-block" href="javascript:login();" ><i class="fas fa-save m-r-5"></i>Save</a>
                  <a class="btn btn-danger btn-block" href="login" ><i class="fas fa-undo-alt m-r-5"></i>Cancel</a>
                </div>
              </form>
...
<script src="product_master.js/Signup.js"></script>
